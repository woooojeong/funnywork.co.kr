...
export default function CEOPage() {
  return (
    <div className="flex">
      <SideNav />
      <div className="flex-1 pt-24 min-h-screen bg-white pb-20">
        {/* 상단: 제목/부제목/설명 */}
        <motion.div
        ...
        <div className="container mx-auto px-4">
          <div className="bg-white rounded-lg shadow flex flex-col md:flex-row items-stretch p-8 md:p-12">
            ...
            >
              <p className="text-lg font-semibold text-gray-800 mb-10 text-left">안녕하십니까?<br/>(주)퍼니웍 대표이사 김태중 입니다.</p>
              ...
              <p className="text-gray-700 mb-8 text-left">감사합니다.</p>
              {/* <div className="flex gap-4 mt-4">
                <button className="bg-blue-600 text-white px-6 py-2 rounded hover:bg-blue-700 transition">회사소개서</button>
                <button className="bg-gray-200 text-gray-800 px-6 py-2 rounded hover:bg-gray-300 transition">제품소개서</button>
              </div> */}
            </motion.div>
            {/* 우측: 대표 사진 및 서명 */}
            <motion.div 
            ...
            >
              <motion.div
                className="w-full h-full rounded-lg overflow-hidden shadow-2xl ring-2 ring-gray-300/30 flex items-center justify-center mb-4 bg-transparent"
                style={{
