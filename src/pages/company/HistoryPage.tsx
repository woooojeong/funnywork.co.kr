    ...
    >
      ...
      <div className="flex items-start gap-8 pl-[45%]">
        <div className="relative min-h-[100px] w-[2px]">
          ...
          />
          <div className="absolute left-0 top-3 w-3 h-3 border-2 border-indigo-900 bg-white rounded-full -translate-x-[5px]" />
        </div>
...
const historyData = [
  { year: '2024', events: ['흥국생명 차세대 프로젝트 참여'] },
  { year: '2023', events: ['SK주식회사 C&C Premium BP社 선정', '저작권등록 AiRBot-N 12건', '코스콤 협력업체 인증', 'SK AI Partners Awards 수상'] },
  { year: '2022', events: ['상표출원 에어봇 관련 5건', '벤처기업 인증갱신'] },
  { year: '2021', events: ['특허출원 2건. 1. 챗봇을 이용한 다국어 지원 시스템 및 방법', '2. 하이브리드 챗봇 서비스 시스템 및 서비스 방법', '이노비즈 인증갱신'] },
  { year: '2020', events: ['우수기술기업 인증 (TCB T-3)', '본사 사옥이전', '국민은행 차세대 시스템 구축 (채널플랫폼, 전행 I/F 구축)', '하나은행 BigData 플랫폼 구축'] },
  { year: '2018', events: ['SK Star BP 선정', '4IR Awards AI/챗봇부문 大賞 수상', "AI챗봇 솔루션 'AiRBot' 출시", '삼성화재 에이전트', "지능형 검색솔루션 'AIIS' 출시", 'AirChatbot-A,F,G,M 4건 저작권등록'] },
  { year: '2017', events: ['매출액 167억 달성', 'SK C&C 전략 BP재선정', 'IBM Watson 파트너 (코오롱)'] },
  { year: '2016', events: ['우리은행, KDB차세대 프로젝트 참여', '매출액 100억 초과달성', 'SK C&C 전략 BP재선정'] },
  { year: '2015', events: ['SK C&C 전략 BP선정', '벤처기업 및 이노비즈 인증 갱신', '특허 1건, 프로그램 3건 등록'] },
  { year: '2013', events: ['기업부설연구소 인증', '이노비즈 인증', '벤처기업 인증', 'SK C&C우수 비즈니스 파트너사 선정'] },
  { year: '2003', events: ['퍼니웍 상호변경'] },
  { year: '2001', events: ['이비즈니스 연구센터 법인 설립'] }
];
